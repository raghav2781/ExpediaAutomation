...
namespace ExpediaAutomation.page_object.Login.constant
{
    public class SearchConstant:BaseTest
    {
        ...
        public static string travellers = "//li[@class='open']//button[@class='trigger-utility menu-trigger btn-utility btn-secondary dropdown-toggle theme-standard pin-left menu-arrow gcw-component gcw-traveler-amount-select gcw-component-initialized']";
